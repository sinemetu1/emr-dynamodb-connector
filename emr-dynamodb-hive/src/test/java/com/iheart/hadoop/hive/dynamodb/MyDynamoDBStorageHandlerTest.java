...
import org.apache.hadoop.hive.dynamodb.DynamoDBStorageHandlerTest;
...
public class MyDynamoDBStorageHandlerTest extends DynamoDBStorageHandlerTest {

  @Before
  @Override
  public void setup() {
    storageHandler = new MyDynamoDBStorageHandler();
  }
